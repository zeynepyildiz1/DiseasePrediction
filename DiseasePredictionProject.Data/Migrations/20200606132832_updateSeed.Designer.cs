...
namespace DiseasePredictionProject.Data.Migrations
{
    ...
    [Migration("20200606132832_updateSeed")]
            ...
            modelBuilder.Entity("DiseasePredictionProject.Core.Models.Question", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 2,
                            QuestionText = "Eklem ağrınız var mı?"
                        },
                        new
                        {
                            Id = 3,
                        ...
                        {
                            Id = 18,
                            QuestionText = "Gün içerisinde görüşünüzün bulanıklaştığı oluyor mu?"
                        });
                });
